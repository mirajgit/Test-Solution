...
$(function (e) {
  ...
  function select2Style1(data) {
    ...
    var $data = $('<span><img src="https://laravelui.spruko.com/noa/assets/images/users/' + data.element.value.toLowerCase() + '.jpg" class="rounded-circle avatar-sm" /> ' + data.text + '</span>');
    return $data;
  }
