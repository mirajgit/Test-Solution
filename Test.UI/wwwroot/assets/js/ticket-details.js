...
$(function () {
  ...
  function selectClient(client) {
    ...
    var $client = $('<span><img src="https://laravelui.spruko.com/noa/assets/images/users/' + client.element.value.toLowerCase() + '.jpg" class="rounded-circle avatar-sm ms-1" /> ' + client.text + '</span>');
    return $client;
  }
