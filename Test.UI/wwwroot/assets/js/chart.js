  ...
  var myChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [(_ref = {
        ...
        borderColor: '#77bc21'
      }, _defineProperty(_ref, "borderWidth", 1), _defineProperty(_ref, "pointBackgroundColor", '#ffffff'), _defineProperty(_ref, "pointRadius", 3), _ref), (_ref2 = {
        label: 'Expenses',
        data: [450, 200, 350, 250, 460, 200, 400],
        borderWidth: 1,
        backgroundColor: 'transparent',
        borderColor: '#e984b1'
      }, _defineProperty(_ref2, "borderWidth", 1), _defineProperty(_ref2, "pointBackgroundColor", '#ffffff'), _defineProperty(_ref2, "pointRadius", 3), _ref2)]
    },
    options: {
      responsive: true,
  ...
  var myChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [(_ref3 = {
        ...
        backgroundColor: 'transparent',
        borderColor: '#b7dd88'
      }, _defineProperty(_ref3, "borderWidth", 1), _defineProperty(_ref3, "radius", 0), _ref3), (_ref4 = {
        label: 'Expenses',
        data: data2,
        borderWidth: 1,
        backgroundColor: 'transparent',
        borderColor: 'rgba(233, 132, 177, 0.5)'
      }, _defineProperty(_ref4, "borderWidth", 1), _defineProperty(_ref4, "radius", 0), _ref4)]
    },
    options: {
      responsive: true,
      maintainAspectRatio: false,
