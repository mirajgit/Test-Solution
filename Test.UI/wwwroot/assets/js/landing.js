...
$('#myonoffswitch24').on('click', function () {
    if (this.checked) {
        ...
        (document.getElementById("style").setAttribute("href", "https://laravelui.spruko.com/noa/assets/plugins/bootstrap/css/bootstrap.rtl.min.css"));
...
$('#myonoffswitch23').on('click', function () {
    if (this.checked) {
        ...
        $("head link#style").attr("href", $(this));
        (document.getElementById("style").setAttribute("href", "https://laravelui.spruko.com/noa/assets/plugins/bootstrap/css/bootstrap.min.css"));
        var carousel = $('.owl-carousel');
        $.each(carousel, function (index, element) {
            // element == this
            var carouselData = $(element).data('owl.carousel');
