...
function selectCountry(country) {
  ...
  if (country.element.value.toLowerCase() !== 'def') {
    var $country = $('<span><img src="https://laravelui.spruko.com/noa/assets/images/flags/' + country.element.value.toLowerCase() + '.svg" class="br-5 avatar-sm" /> ' + country.text + '</span>');
    return $country;
  }
}
