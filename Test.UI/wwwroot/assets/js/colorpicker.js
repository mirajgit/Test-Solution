...
$(function () {
  ...
  var _loop = function _loop() {
    ...
    button.addEventListener('click', function () {
      ...
      pickr.on('init', function (instance) {// console.log('Event: "init"', instance);
      }).on('hide', function (instance) {// console.log('Event: "hide"', instance);
      }).on('show', function (color, instance) {// console.log('Event: "show"', color, instance);
      }).on('save', function (color, instance) {// console.log('Event: "save"', color, instance);
      }).on('clear', function (instance) {// console.log('Event: "clear"', instance);
      }).on('change', function (color, source, instance) {// console.log('Event: "change"', color, source, instance);
      }).on('changestop', function (source, instance) {// console.log('Event: "changestop"', source, instance);
      }).on('cancel', function (instance) {// console.log('cancel', pickr.getColor().toRGBA().toString(0));
      }).on('swatchselect', function (color, instance) {// console.log('Event: "swatchselect"', color, instance);
      });
    });
  ...
  var _loop2 = function _loop2() {
    ...
    button.addEventListener('click', function () {
      ...
      monolithPickr.on('init', function (instance) {// console.log('Event: "init"', instance);
      }).on('hide', function (instance) {// console.log('Event: "hide"', instance);
      }).on('show', function (color, instance) {// console.log('Event: "show"', color, instance);
      }).on('save', function (color, instance) {// console.log('Event: "save"', color, instance);
      }).on('clear', function (instance) {// console.log('Event: "clear"', instance);
      ...
      }).on('cancel', function (instance) {// console.log('cancel', monolithPickr.getColor().toRGBA().toString(0));
      }).on('swatchselect', function (color, instance) {// console.log('Event: "swatchselect"', color, instance);
      });
    });
  ...
  var _loop3 = function _loop3() {
    ...
    button.addEventListener('click', function () {
      ...
      nanoPickr.on('init', function (instance) {// console.log('Event: "init"', instance);
      }).on('hide', function (instance) {// console.log('Event: "hide"', instance);
      }).on('show', function (color, instance) {// console.log('Event: "show"', color, instance);
      }).on('save', function (color, instance) {// console.log('Event: "save"', color, instance);
      }).on('clear', function (instance) {// console.log('Event: "clear"', instance);
      ...
      }).on('cancel', function (instance) {// console.log('cancel', nanoPickr.getColor().toRGBA().toString(0));
      }).on('swatchselect', function (color, instance) {// console.log('Event: "swatchselect"', color, instance);
      });
    });
